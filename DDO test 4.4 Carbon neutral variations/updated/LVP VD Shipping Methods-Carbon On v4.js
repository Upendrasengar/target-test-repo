(function () {
    if (!window.carbonNeutralVariation) {
        ...
        function modifyLabelV4(labelNode) {
            ...
            $(labelNode).find('switch-header').closest('div').append('<p style="font-size:0.92em;">Through UPS carbon neutral, you\'re supporting environmental projects that counterbalance the emissions associated with shipping your package. Up to $0.20 for domestic US shipments. Up to $0.75 for international shipments.</p>');
