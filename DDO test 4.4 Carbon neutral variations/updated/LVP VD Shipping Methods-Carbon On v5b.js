(function () {
    if (!window.carbonNeutralVariation) {
        ...
        function modifyLabelV6(labelNode) {
            ...
            $(labelNode).find('switch-header').closest('div').append('<details open><summary class="detail-label-summary"><span id="carbonNeutralLearnMore" style="text-decoration: underline;">Learn More</span></summary><p style="font-size:0.95em;">Through UPS carbon neutral, you\'re supporting environmental projects that counterbalance the emissions associated with shipping your package. Up to $0.20 for domestic US shipments. Up to $0.75 for international shipments.</p></details>');
        }
