    ...
    if (!window.hasGuidedTestExecuted) {
        ...
        function pickupDate() {
            ...
            if (ele || window.pickupCharges) {
                ...
                $("[for=nbsShipmentServicesDropOffPickupViewToggleOption1InputId]").html("Drop-off shipment or include it in another pick-up <span class='cust-message'>SAVE " + window.pickupCharges + "</span>");
            } else {
